...
Try {
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		$registryPath = "HKLM:\SOFTWARE\WOW6432Node\LanSchool"
		$Name = "IPSubnet"
		$value = "MS210911.winad.msudenver.edu"
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Remove-ItemProperty -Path "HKLM:\SOFTWARE\WOW6432Node\LanSchool\" -Name "IPSubnet" -Force
		Remove-ItemProperty -Path "HKLM:\SOFTWARE\WOW6432Node\LanSchool\" -Name "IPSubnetMask" -Force
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUskkDcvkb3oMttcyA3SG28+Wg
# 18ygghHXMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# MRYEFJGboD3NYOQLta4nm6735ixVS3y8MA0GCSqGSIb3DQEBAQUABIIBgH0dq6VC
# v+FkSNoeWbd9TPJ4OkB7NhCif6OMMiJ7QMl8MR+wLFEgEUbXwAY+liLiOO/c9Iw5
# aUy4xJU9F9Cy52m/+v6tQ9Z/wP4CHDzBbQe9Pme8otpE87lrsQzNfhzzqhKH1JIo
# TwcK/JbLLWJed1ulvRe7xnC8VsoDuZEY5B3F4VvDTDaXE4AyC7E8uo4HZa5mNIiU
# Sy8iDNIeVei4O1d7hA+vAMgAYvR1rCKGY8up1To88aTpYQS7Upcy7x2dHlTgIUCn
# xZ4dbvfrQi5JgKHH5VeegMBkw8Q4OmibVmL6V+TVUUW/SuSNErFckMnEVfB6UN1K
# 4F9mUSFtrHHWrvZGmCzQ73ZHZXwGxw7OlKBZxNi0ktuNDDOKstdAveii9pX+Mo2I
# PvVq7b0Rn1wx8A8HT4oamEg2km+y+ut5Cw6O3pRC+NXzVI08QQHLTlOFhVBmE4qo
# JL/HZzanZyvvBvULIYkbRLUkRQm9FwNw+AJ4EyN9FT2cjMx91HyR1tK8sA==
